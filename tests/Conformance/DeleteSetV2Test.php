<?php
/**
 * Delete-set V2 conformance tests.
 *
 * @package Yjs
 */
...
use Yjs\Utils\DSDecoderV2;
use Yjs\Utils\DSEncoderV2;

use function Yjs\readDeleteSet;
use function Yjs\writeDeleteSet;

/**
 * Verifies V2 delete-set byte parity with fixtures captured from real yjs.
 */
final class DeleteSetV2Test extends TestCase {
	/**
	 * @return array<int,array{0:array<string,mixed>}>
	 */
	public function deleteSetCaseProvider(): array {
		$fixture = $this->fixture( 'delete-set-v2.json' );
		return array_map(
	...
	public function testWriteDeleteSetMatchesJsBytesAndReadRoundTrips( array $case ): void {
		...
		$decoder = new DSDecoderV2( Decoding::createDecoder( Buffer::fromHexString( $case['hex'] ) ) );
